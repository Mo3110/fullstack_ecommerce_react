...
var createOrder = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, deliveryAddress, totalPrice, user, orderItems, totalAmount, paymentIntent, order, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = request.body, deliveryAddress = _a.deliveryAddress, totalPrice = _a.totalPrice, user = _a.user, orderItems = _a.orderItems;
            ...
            case 3:
                error_1 = _b.sent();
                console.log("error in createOrder", error_1);
                response.send({
